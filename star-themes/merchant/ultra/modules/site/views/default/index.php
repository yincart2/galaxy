            ...
            <div class="profile-info row">
                ...
                <div class="profile-image col-md-4 col-sm-4 col-xs-4">
                    <a href="ui-profile.html">
                        <img src="<?= $url ?>/data/profile/profile.png" class="img-responsive img-circle">
                    </a>
                </div>
        ...
        <div class="chat-wrapper">
            ...
            <ul class="contact-list">
                ...
                <li class="user-row" id='chat_user_1' data-user-id='1'>
                    <div class="user-img">
                        <a href="#"><img src="<?= $url ?>/data/profile/avatar-1.png" alt=""></a>
                    </div>
                    <div class="user-info">
                ...
                <li class="user-row" id='chat_user_2' data-user-id='2'>
                    <div class="user-img">
                        <a href="#"><img src="<?= $url ?>/data/profile/avatar-2.png" alt=""></a>
                    </div>
                    <div class="user-info">
                ...
                <li class="user-row" id='chat_user_3' data-user-id='3'>
                    <div class="user-img">
                        <a href="#"><img src="<?= $url ?>/data/profile/avatar-3.png" alt=""></a>
                    </div>
                    <div class="user-info">
            ...
            <ul class="contact-list">
                ...
                <li class="user-row" id='chat_user_4' data-user-id='4'>
                    <div class="user-img">
                        <a href="#"><img src="<?= $url ?>/data/profile/avatar-4.png" alt=""></a>
                    </div>
                    <div class="user-info">
                ...
                <li class="user-row" id='chat_user_5' data-user-id='5'>
                    <div class="user-img">
                        <a href="#"><img src="<?= $url ?>/data/profile/avatar-5.png" alt=""></a>
                    </div>
                    <div class="user-info">
