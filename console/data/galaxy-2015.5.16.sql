...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `is_promote` tinyint(1) unsigned  NULL DEFAULT '0' COMMENT '是否促销',
  `is_new` tinyint(1) unsigned  NULL DEFAULT '0' COMMENT '是否新品',
  `is_hot` tinyint(1) unsigned  NULL DEFAULT '0' COMMENT '是否热销',
  `is_best` tinyint(1) unsigned  NULL DEFAULT '0' COMMENT '是否精品',
  `click_count` int(10) unsigned  NULL DEFAULT '0' COMMENT '点击量',
  `wish_count` int(10) unsigned  NULL DEFAULT '0' COMMENT '收藏数',
